...
<!DOCTYPE html>
<html lang="en" class="" style="height: 900px;">
                ...
                <div class="card card-outline card-warning col-12 rounded-0 shadow">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row align-item-end">
                            <div class="col-8">
                                <a href="<?= base_url ?>" class="font-weight-bold text-warning">Back to Site</a>
                            </div>
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn btn-warning btn-block btn-flat text-white font-weight-bold">Create Account</button>
                            </div>
                            <div class="col-12 text-center pt-3">
                            <a href="<?= base_url.'vendor/login.php' ?>" class="font-weight-bold text-warning">Already have an Account</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
