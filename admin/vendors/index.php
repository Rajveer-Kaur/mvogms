					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($row['status'] == 1): ?>
									<span class="bage badge-warning px-3 rounded-pill text-white">Active</span>
								<?php else: ?>
									<span class="bage badge-danger px-3 rounded-pill text-white">Inactive</span>
								<?php endif; ?>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=vendors/manage_vendor&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-warning"></span> Edit</a>
