...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-warning text-white font-weight-bold shadow">
		<div class="card-body">
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-warning text-white font-weight-bold" form="manage-user">Update</button>
				</div>
			</div>
		</div>
	</div>
