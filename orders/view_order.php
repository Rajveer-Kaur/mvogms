...
<div class="container-fluid">
	<div class="row">
        <div class="col-3 border bg-gradient-warning text-white font-weight-bolder"><span class="">Reference Code</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($code) ? $code : '' ?></span></div>
        <div class="col-3 border bg-gradient-warning text-white font-weight-bolder"><span class="">Vendor</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($shop_name) ? $vcode.' - '.$shop_name : '' ?></span></div>
        <div class="col-3 border bg-gradient-warning text-white font-weight-bolder"><span class="">Delivery Address</span></div>
        <div class="col-9 border"><span class="font-weight-bolder"><?= isset($delivery_address) ? $delivery_address : '' ?></span></div>
        <div class="col-3 border bg-gradient-warning text-white font-weight-bolder"><span class="">Status</span></div>
            ...
            $status = isset($status) ? $status : '';
                switch($status){
                    case 0:
                        ...
                        break;
                    case 1:
                        echo '<span class="badge badge-warning bg-gradient-warning px-3 rounded-pill">Confirmed</span>';
                        break;
                    case 2:
