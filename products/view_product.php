                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-warning font-weight-bold"><?= format_num($price) ?></small></p></div>
                        </div>
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3 form-group">
                                <button class="btn btn-warning btn-flat text-white" type="button" id="add_to_cart"><i class="fa fa-cart-plus"></i> Add to Cart</button>
                            </div>
                        </div>
