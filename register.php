...
<!DOCTYPE html>
<html lang="en" class="" style="height: 1000px;">
  ...
  <div class="d-flex justify-content-center align-items-center flex-row h-100">
        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-warning col-12 rounded-0 shadow">
                    <div class="card-header text-center">
                    <a href="./register.php" class="h1"><b>Create an Account</b></a>
                    </div>
                    <div class="card-body">
                    <p class="login-box-msg text-warning font-weight-bold">Sign in to start your session</p>
                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row align-item-end">
                            <div class="col-8">
                                <a href="<?= base_url ?>" class="text-warning font-weight-bold">Back to Site</a>
                            </div>
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn btn-warning text-white btn-block btn-flat">Create Account</button>
                            </div>
                            <div class="col-12 text-center pt-4">
                            <a href="<?= base_url.'./login.php' ?>" class="text-warning font-weight-bold" >Already have an Account</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
